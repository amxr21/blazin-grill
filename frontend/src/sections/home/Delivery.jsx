    ...
    return (
        <div id="Delivery" className="mb-32">
            <div className="banner-image relative">
                ...
                <div className="banner-text font-[Stinger] text-2xl lg:text-7xl font-bold text-white absolute w-full h-full px-16 top-0 uppercase flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2">
